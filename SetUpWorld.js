const camPos = new Float32Array([0.0, -0.4, 0.5]);//new Float32Array([0.05, -0.4, 0.25]);
const camDir = new Float32Array([0, 0]);//new Float32Array([-0.15, 0.05]);
...
createSphere(0,-1.5,5, 1, 0.9,0.9,0.9, 0, 1, 1, 1, 1.5168, 1,1,1, 1,1,1); // glass ball
createSphere(0,-9002.5,0, 9000, 0.5,0.5,0.5); // floor*/

createSphere(-1,-1.5,7.5, 1, 0.75,0.75,0.75, 0, 0.95); // mirror ball
createSphere(1,-1.5,6, 1, 0.9,0.9,0.9, 0, 1, 1, 1, 1.5168, 1,1,1, 1,1,1); // glass ball
createSphere(-2002.5,0,0, 2000, 1,0,0);
createSphere(2002.5,0,0, 2000, 0,1,0);
createSphere(0,2002,0, 2000, 0.5,0.5,0.5);
createSphere(0,0,2010, 2000, 0.5,0.5,0.5);
createSphere(0,0,-1999.9, 2000, 0.5,0.5,0.5);
createSphere(0,51.97,6, 50, 1,1,1, 10);
createSphere(0,-2002.5,0, 2000, 0.5,0.5,0.5); // floor
